    ...
    return (
        <div>
            <div className='flex justify-evenly mb-8'>
                ...
                {
                    cart.length?<Link to={'/dashboard/payment'}><button disabled={!cart.length} className='btn btn-primary'>Pay</button></Link>:<button className='btn btn-primary'>Pay</button>
                }
            </div>
